...
import com.ydl.videoplaylib.inter.listener.OnTextureListener;
...
import com.ydl.videoplaylib.view.VideoTextureView;
...
public class VideoMediaPlayer {
    ...
    private void createIjkMediaPlayer() {
        ...
        ((IjkMediaPlayer)mMediaPlayer).setOption(player, "framedrop", 1L);//或者 5
        //最大fps （每秒传输的帧数）
